...
private void minimize()
  ...
  Console.WriteLine(group.Count.ToString() + " states after removal of redundant states.");
...
private void pgroups()
  ...
  for (int i = 0; i < group_size; ++i)
    {
    Console.Write("\tGroup " + i.ToString() + " {");
  ...
  for (int i = 0; i < dtrans_size; ++i)
    {
    Console.WriteLine("\tstate " + i.ToString()
		      + " is in group " + ingroup[i].ToString());
    }
  }
}
}
